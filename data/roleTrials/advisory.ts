...
const profiles: RoleProfileInput[] = [
  {
    ...
    activities: [["Structuring ambiguous problems", "Product & Strategy"], ["Planning strategic analysis", "Analysis"], ["Developing recommendations", "Product & Strategy"], ["Planning implementation", "Execution"]],
  ...
  },
  {
    ...
    activities: [["Defining policy problems", "Product & Strategy"], ["Analysing stakeholder impacts", "Analysis"], ["Comparing policy options", "Analysis"], ["Designing evaluation safeguards", "Planning & Design"]],
  ...
  },
  {
    ...
    activities: [["Diagnosing organisational systems", "Analysis"], ["Planning participatory discovery", "Research"], ["Designing organisational interventions", "Planning & Design"], ["Evaluating ways of working", "Analysis"]],
  ...
  },
  {
    ...
    activities: [["Prioritising audience segments", "Product & Strategy"], ["Developing positioning", "Product & Strategy"], ["Designing message activation", "Planning & Design"], ["Testing marketing strategy", "Analysis"]],
