...
const profiles: RoleProfileInput[] = [
  {
    ...
    activities: ["Framing product problems", "Prioritising competing options", "Making explicit trade-offs", "Defining success measures"],
  ...
  },
  {
    ...
    activities: ["Formulating analytical questions", "Defining data and variables", "Selecting analytical methods", "Validating and communicating findings"],
  ...
  },
  {
    ...
    activities: ["Defining product journeys", "Choosing product metrics", "Segmenting user behaviour", "Turning analysis into product decisions"],
  ...
  },
  {
    ...
    activities: ["Mapping current processes", "Clarifying stakeholder needs", "Defining requirements", "Writing acceptance conditions"],
