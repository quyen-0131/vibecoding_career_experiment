...
const profiles: RoleProfileInput[] = [
  {
    ...
    activities: ["Explaining human behaviour", "Generating testable predictions", "Designing behavioural interventions", "Designing credible tests"],
  ...
  },
  {
    ...
    activities: ["Framing research questions", "Designing qualitative studies", "Reducing research bias", "Synthesising user evidence"],
  ...
  },
  {
    ...
    activities: ["Framing consumer questions", "Designing mixed-method research", "Developing consumer insights", "Translating insight into decisions"],
  ...
  },
  {
    ...
    activities: ["Mapping end-to-end journeys", "Diagnosing service breakdowns", "Designing coordinated services", "Prototyping service changes"],
